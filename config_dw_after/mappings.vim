...
au MyAutoCmd Filetype markdown nnoremap <silent>;b :call dway#markdown#OpenInBrowser('%')<cr><cr>
au MyAutoCmd Filetype markdown nnoremap <silent>ob :call dway#markdown#OpenInBrowser('%')<cr><cr>
